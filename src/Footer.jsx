          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400">
                I'm Alain Niganze, a passionate software developer specialized in front-end and full-stack development. I love creating modern and responsive web applications.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <div className="flex space-x-4">
                  <a href="https://github.com/niganze" className="text-gray-400 hover:text-white">
                  ...
                  <a href="https://twitter.com/niganze" className="text-gray-400 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a href="https://linkedin.com/in/niganze" className="text-gray-400 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
