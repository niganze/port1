          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-6 animate-pulse">
                ...
                <a href="https://twitter.com/niganze" className="text-gray-400 hover:text-[#32F6FF] transition-colors duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://linkedin.com/in/niganze" className="text-gray-400 hover:text-[#32F6FF] transition-colors duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
