      ...
      <div className="flex justify-between">
        ...
        <div className="w-full lg:w-2/3 space-y-12">
          {[1, 2, 3].map((blog, index) => (
            <div
              key={index}
              className="flex bg-[#1e1e2f] rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 transform hover:-translate-y-2 animate-fade-in-up"
            >
              {/* Blog Image */}
              <img
                src={BlogImage}
                alt="Blog Post"
                className="rounded-l-lg w-1/2 h-auto object-cover"
              />
              {/* Blog Details */}
        ...
        <div className="hidden lg:block lg:w-1/4 bg-[#1e1e2f] p-6 rounded-lg shadow-lg ml-8">
